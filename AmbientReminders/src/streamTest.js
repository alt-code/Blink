...
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
var is_runnung = false;

function Flashes2(n, fadeMillis, color, lightness, ledn) {
    // default value
    lightness = typeof lightness !== 'undefined' ? lightness : 1;
    ...
    if (is_runnung === false) {
        ...
        blink1.fadeToRGB(fadeMillis, r, g, b, ledn, function() {
            blink1.fadeToRGB(fadeMillis, 0, 0, 0, ledn, function() {
                is_runnung = false;
                Flashes2(n - 1, fadeMillis, color, lightness, ledn);
            });
        });

    } else {
        sleep(1000);
        Flashes2(n, fadeMillis, color, lightness, ledn);
    }
}
